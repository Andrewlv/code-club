...
public class SubjectInfoDTOConverterImpl implements SubjectInfoDTOConverter {
    ...
    public SubjectInfoBO convertDTOToBO(SubjectInfoDTO subjectInfoDTO) {
        ...
        List<String> list3 = subjectInfoDTO.getLabelNameList();
        if ( list3 != null ) {
            subjectInfoBO.setLabelNameList( new ArrayList<String>( list3 ) );
        }
        ...
        subjectInfoBO.setLiked_count( subjectInfoDTO.getLiked_count() );
    ...
    public SubjectInfoDTO convertBOToDTO(SubjectInfoBO subjectInfoBO) {
        ...
        List<String> list3 = subjectInfoBO.getLabelNameList();
        if ( list3 != null ) {
            subjectInfoDTO.setLabelNameList( new ArrayList<String>( list3 ) );
        }
        subjectInfoDTO.setKeyWord( subjectInfoBO.getKeyWord() );
        subjectInfoDTO.setLiked( subjectInfoBO.getLiked() );
        subjectInfoDTO.setLiked_count( subjectInfoBO.getLiked_count() );
