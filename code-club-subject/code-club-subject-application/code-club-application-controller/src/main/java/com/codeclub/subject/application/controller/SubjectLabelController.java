...
public class SubjectLabelController {
    ...
    public Result<Boolean> add(@RequestBody SubjectLabelDTO subjectLabelDTO) {
        try {
            ...
            log.error("SubjectLabelController.add.error:{}", JSON.toJSONString(subjectLabelDTO));
    ...
    public Result<Boolean> update(@RequestBody SubjectLabelDTO subjectLabelDTO) {
        try {
            ...
            log.error("SubjectLabelController.update.error:{}", JSON.toJSONString(subjectLabelDTO));
    ...
    public Result<Boolean> delete(@RequestBody SubjectLabelDTO subjectLabelDTO) {
        try {
            ...
            log.error("SubjectLabelController.delete.error:{}", JSON.toJSONString(subjectLabelDTO));
    ...
    public Result<List<SubjectLabelDTO>> queryLabelByCategoryId(@RequestBody SubjectLabelDTO subjectLabelDTO) {
        try {
            ...
            log.error("SubjectLabelController.queryLabelByCategoryId.error:{}", JSON.toJSONString(subjectLabelDTO));
